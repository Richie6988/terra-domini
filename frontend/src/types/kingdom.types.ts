...
export const PRODUCTION_CHAINS: ProductionChain[] = [
  { id: 'steel_armor',    name: 'Steel Forging',    icon: '🗡️', inputs: [{ resource: 'fer', amount: 50 }, { resource: 'charbon', amount: 30 }], output: { resource: 'acier', amount: 40 } },
  { id: 'electronics',    name: 'Electronics',      icon: '💻', inputs: [{ resource: 'silicium', amount: 30 }, { resource: 'aluminium', amount: 20 }], output: { resource: 'composants', amount: 25 } },
  { id: 'battery_tech',   name: 'Battery Tech',     icon: '🔋', inputs: [{ resource: 'lithium', amount: 20 }, { resource: 'cobalt', amount: 15 }], output: { resource: 'composants', amount: 35 } },
  { id: 'nuclear_power',  name: 'Nuclear Power',    icon: '☢️', inputs: [{ resource: 'uranium', amount: 10 }, { resource: 'eau', amount: 50 }], output: { resource: 'cristaux', amount: 200 }, unlockSkill: 'tech3' },
  ...
  { id: 'geopolitical',   name: 'Soft Power',       icon: '🌐', inputs: [{ resource: 'influence', amount: 30 }, { resource: 'stabilite', amount: 20 }], output: { resource: 'influence', amount: 60 }, unlockSkill: 'dip3' },
]
...
export const SKILL_BRANCHES: SkillBranch[] = [
  {
    ...
    skills: [
      ...
      // Fork at tier 2
      { id: 'atk2a', name: 'Mechanical Assault',   icon: '🦾', cost: 2000,  effect: 'Brute ATK +40%, ignore terrain', description: 'Heavy armor overwhelming force', prereqs: ['atk1'], tier: 2, isFork: true, forkGroup: 'atk_fork' },
      { id: 'atk2b', name: 'Cyber Warfare',        icon: '💻', cost: 2000,  effect: 'Disable DEF 6h before attack',   description: 'Electronic warfare pre-strike', prereqs: ['atk1'], tier: 2, isFork: true, forkGroup: 'atk_fork' },
      { id: 'atk3', name: 'Double Assault',         icon: '⚔️', cost: 4000,  effect: 'Attack 2 hexes simultaneously',  description: 'Coordinated multi-front offense', prereqs: ['atk2a', 'atk2b'], tier: 3 },
      { id: 'atk4', name: 'Artillery Position',     icon: '🚀', cost: 7000,  effect: 'Range +2, area damage',          description: 'Long-range fire support', prereqs: ['atk3'], tier: 4 },
      { id: 'atk5', name: 'Total Domination',       icon: '👑', cost: 15000, effect: 'Ultimate: Nuke Strike',           description: 'Annihilate all defenses in target zone', prereqs: ['atk4'], tier: 5, isUltimate: true },
    ],
  },
  {
    ...
    skills: [
      ...
      { id: 'def2a', name: 'Extended Resistance',    icon: '🏔️', cost: 2000,  effect: 'DEF bonus persists 48h',        description: 'Sustained defense posture', prereqs: ['def1'], tier: 2, isFork: true, forkGroup: 'def_fork' },
      { id: 'def2b', name: 'Auto Riposte',           icon: '⚡', cost: 2000,  effect: 'Counter-attack 30% on defense', description: 'Automated retaliation systems', prereqs: ['def1'], tier: 2, isFork: true, forkGroup: 'def_fork' },
      { id: 'def3', name: 'Underground Bunker',      icon: '🕳️', cost: 4000,  effect: 'Protect 80% resources on loss', description: 'Hidden secure storage', prereqs: ['def2a', 'def2b'], tier: 3 },
      { id: 'def4', name: 'Detection Network',       icon: '👁️', cost: 7000,  effect: 'Vision +3 hex, detect stealth', description: 'Total territorial surveillance', prereqs: ['def3'], tier: 4 },
      { id: 'def5', name: 'Impregnable Citadel',     icon: '🏰', cost: 15000, effect: 'Ultimate: Shield 12h/week',      description: 'Inviolable fortress mode', prereqs: ['def4'], tier: 5, isUltimate: true },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 'dip2a', name: 'Soft Power',              icon: '🤝', cost: 2000,  effect: 'Auto-rally neutral hex/week',   description: 'Peaceful expansion through charm', prereqs: ['dip1'], tier: 2, isFork: true, forkGroup: 'dip_fork' },
      { id: 'dip2b', name: 'Black Propaganda',        icon: '🕵️', cost: 2000,  effect: 'See enemy armies + sabotage',   description: 'Spy network and disinformation', prereqs: ['dip1'], tier: 2, isFork: true, forkGroup: 'dip_fork' },
      { id: 'dip3', name: 'Economic Annexation',      icon: '💼', cost: 4000,  effect: 'Force-buy any territory',       description: 'Hostile takeover mechanism', prereqs: ['dip2a', 'dip2b'], tier: 3 },
      ...
      { id: 'dip5', name: 'World Order',              icon: '🌍', cost: 15000, effect: 'Ultimate: Regional control',     description: 'Diplomatic hegemony', prereqs: ['dip4'], tier: 5, isUltimate: true },
    ],
  },
  {
    ...
    skills: [
      ...
      { id: 'tech2a', name: 'Militech',               icon: '🦾', cost: 2000,  effect: 'All units +20% stats',          description: 'Military technology integration', prereqs: ['tech1'], tier: 2, isFork: true, forkGroup: 'tech_fork' },
      { id: 'tech2b', name: 'Biotech',                icon: '🧬', cost: 2000,  effect: 'Heal units, reduce casualties', description: 'Biological enhancement research', prereqs: ['tech1'], tier: 2, isFork: true, forkGroup: 'tech_fork' },
