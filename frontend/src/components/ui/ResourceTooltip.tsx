...
export const RESOURCE_INFO: Record<string, {
  ...
  res_fer:         { icon: '⚙️', color: '#A8A29E', label: 'Fer',          desc: 'Minerai de base pour la construction.', usedFor: 'Fortifications, Mines, Builds défensifs', biomes: ['mountain'] },
  res_acier:       { icon: '🔩', color: '#78716C', label: 'Acier',        desc: 'Fer transformé, plus résistant.', usedFor: 'Bunkers, Réacteurs, Attaque mécanisée', biomes: ['industrial'] },
  res_titanium:    { icon: '🔷', color: '#93C5FD', label: 'Titanium',     desc: 'Métal rare ultra-résistant.', usedFor: 'Builds haute tech, Skill Bastion imprenable', biomes: ['mountain'] },
  res_petrole:     { icon: '🛢️', color: '#F59E0B', label: 'Pétrole',      desc: 'Énergie fossile stratégique.', usedFor: 'Skill Attaque, Raffineries, Transport', biomes: ['desert'] },
  res_gaz:         { icon: '💨', color: '#BAE6FD', label: 'Gaz naturel',  desc: 'Énergie propre mais volatile.', usedFor: 'Énergie, Reacteur (combo uranium)', biomes: ['coastal','tundra'] },
  res_uranium:     { icon: '☢️', color: '#4ADE80', label: 'Uranium',      desc: 'Énergie nucléaire — ressource rare.', usedFor: 'Réacteur nucléaire × 5 production, Skill Bastion', biomes: ['tundra'] },
  ...
  res_silicium:    { icon: '💠', color: '#818CF8', label: 'Silicium',     desc: 'Base de l\'électronique moderne.', usedFor: 'Composants, Centre de données, Skill Tech', biomes: ['desert'] },
  res_terres_rares:{ icon: '💎', color: '#EC4899', label: 'Terres rares', desc: 'Minerais critiques pour la haute technologie.', usedFor: 'IA, Quantum, Skill Frappe à distance', biomes: ['desert'] },
  res_lithium:     { icon: '🔋', color: '#A78BFA', label: 'Lithium',      desc: 'Batterie du futur.', usedFor: 'Port spatial, Skill Nanotechnologie', biomes: ['tundra'] },
  res_cobalt:      { icon: '🔵', color: '#3B82F6', label: 'Cobalt',       desc: 'Alliage pour batteries haute densité.', usedFor: 'Batteries avancées (combo lithium)', biomes: ['mountain'] },
  ...
  res_aluminium:   { icon: '🪙', color: '#D1D5DB', label: 'Aluminium',    desc: 'Léger, conducteur, polyvalent.', usedFor: 'Constructions légères, Port spatial', biomes: ['industrial'] },
  res_composants:  { icon: '🔌', color: '#8B5CF6', label: 'Composants',   desc: 'Pièces électroniques assemblées.', usedFor: 'Centre de données, Skill IA, Cyberguerre', biomes: ['industrial','coastal'] },
  res_donnees:     { icon: '📊', color: '#60A5FA', label: 'Données',      desc: 'Information = pouvoir au XXIe siècle.', usedFor: 'Skill Tech, Influence, Infiltration, Vision carte', biomes: ['urban','landmark'] },
  res_influence:   { icon: '🌐', color: '#C084FC', label: 'Influence',    desc: 'Capacité à convaincre, à rayonner.', usedFor: 'Skill Influence, Blocus, Soft power, Alliances', biomes: ['urban','landmark'] },
  res_main_oeuvre: { icon: '👷', color: '#FCD34D', label: 'Main-d\'œuvre',desc: 'Population active de ton territoire.', usedFor: 'Fermes, Mines, Accélération builds', biomes: ['urban','rural'] },
