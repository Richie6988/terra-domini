    ...
    <div>
      ...
      {streak > 0 && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', marginBottom: 12,
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: '#6B7280' }}>Continuez ! Bonus ×{(1 + streak * 0.05).toFixed(2)} demain</div>
          </div>
        </div>
      )}
      ...
      {allComplete && (
        <div style={{ textAlign: 'center', padding: '10px', marginBottom: 12,
          ...
          <div style={{ fontSize: 10, color: '#6B7280', marginTop: 2 }}>Revenez demain pour de nouvelles missions</div>
        </div>
      )}

      {/* Liste missions */}
      {missions.length === 0 && !isLoading && (
        <div style={{ textAlign: 'center', padding: '20px', color: '#4B5563', fontSize: 12 }}>
        ...
        {missions.map((m: any) => {
          ...
          return (
            <div key={m.id} style={{
              ...
              border: `1px solid ${m.completed ? 'rgba(16,185,129,0.2)' : 'rgba(255,255,255,0.07)'}`,
              ...
              <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
                    <span style={{ fontSize: 12, color: '#fff', fontWeight: 600, lineHeight: 1.3 }}>{m.title}</span>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 5 }}>
                    <span style={{ fontSize: 10, color: '#6B7280' }}>{m.current}/{m.target}</span>
                    {canClaim && (
  ...
  if (isLoading) return (
    <div style={{ padding: '28px', textAlign: 'center' }}>
      <motion.div animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: 'linear' }}
        style={{ width: 22, height: 22, border: '2px solid rgba(255,255,255,0.08)', borderTopColor: '#8B5CF6',
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 16 }}>
        {[
          ...
          <div key={s.label} style={{ background: 'rgba(255,255,255,0.04)', borderRadius: 9, padding: '10px 12px',
        ...
        <div>
          ...
          {referrals.map((r: any, i: number) => (
            <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center',
              ...
              <div>
                <span style={{ fontSize: 12, color: '#fff', fontWeight: 600 }}>{r.username}</span>
