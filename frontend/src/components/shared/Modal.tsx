        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              borderRadius: 12,
              boxShadow: '0 20px 60px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.8)',
              display: 'flex',
        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              borderRadius: 10,
              boxShadow: '0 24px 70px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.9)',
              display: 'flex',
              flexDirection: 'column',
              overflow: 'hidden',
            }}
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: disabled ? 'none' : '0 2px 8px rgba(0,50,80,0.1), inset 0 1px 0 rgba(255,255,255,0.8)',
        transition: 'all 0.25s ease',
