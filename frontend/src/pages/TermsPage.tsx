    ...
    <div style={{
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        style={{
          ...
          border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 8px 40px rgba(0,0,0,0.08)',
        }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.4)', letterSpacing: 2, marginTop: 4 }}>TERMS OF SERVICE & PRIVACY POLICY</div>
        </div>
        ...
        {[
          ...
          <div key={s.title} style={{ marginBottom: 20 }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#e2e8f0', marginBottom: 6, fontFamily: "'Orbitron', sans-serif", letterSpacing: 1 }}>{s.title}</div>
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', lineHeight: 1.8 }}>{s.body}</div>
          </div>
        ))}

        <div style={{ textAlign: 'center', marginTop: 32, paddingTop: 20, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 8, color: 'rgba(255,255,255,0.25)', letterSpacing: 2 }}>Last updated: April 2026</div>
