...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True)),
                ('poi', models.ForeignKey('events.WorldPOI', on_delete=models.deletion.CASCADE,
                    related_name='player_interactions')),
                ('player_id', models.UUIDField(db_index=True, null=True, blank=True)),
